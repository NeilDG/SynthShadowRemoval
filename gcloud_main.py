...
def main():
    ...
    os.system("python \"shading_main_albedo.py\" --server_config=3 --num_workers=8 --img_to_load=-1 --load_previous=0 --test_mode=0 --patch_size=64 --batch_size=256 --net_config=1 --num_blocks=6 "
              "--l1_weight=10.0 --lpip_weight=1.0 --ssim_weight=0.0 --adv_weight=1.0 --use_bce=0 --mode=elevation --min_epochs=100 --light_angle=0 "
              "--version_name=\"rgb2shading_v7.09\" --iteration=1")

    os.system("python \"shading_main_albedo.py\" --server_config=3 --num_workers=8 --img_to_load=-1 --load_previous=1 --test_mode=0 --patch_size=64 --batch_size=256 --net_config=1 --num_blocks=6 "
    ...
    os.system("python \"shading_main_albedo.py\" --server_config=3 --num_workers=8 --img_to_load=-1 --load_previous=1 --test_mode=0 --patch_size=64 --batch_size=256 --net_config=1 --num_blocks=6 "
              "--l1_weight=10.0 --lpip_weight=1.0 --ssim_weight=0.0 --adv_weight=1.0 --use_bce=0 --mode=elevation --min_epochs=400 --light_angle=108 "
              "--version_name=\"rgb2shading_v7.09\" --iteration=1")

    os.system("python \"shading_main_albedo.py\" --server_config=3 --num_workers=8 --img_to_load=-1 --load_previous=1 --test_mode=0 --patch_size=64 --batch_size=256 --net_config=1 --num_blocks=6 "
              "--l1_weight=10.0 --lpip_weight=1.0 --ssim_weight=0.0 --adv_weight=1.0 --use_bce=0 --mode=elevation --min_epochs=500 --light_angle=144 "
              "--version_name=\"rgb2shading_v7.09\" --iteration=1")

    os.system("python \"shading_main_albedo.py\" --server_config=3 --num_workers=8 --img_to_load=-1 --load_previous=0 --test_mode=0 --patch_size=64 --batch_size=512 --net_config=2 --num_blocks=0 "
              "--l1_weight=10.0 --lpip_weight=1.0 --ssim_weight=0.0 --adv_weight=1.0 --use_bce=0 --mode=elevation --min_epochs=100 --light_angle=0 "
              "--version_name=\"rgb2shading_v7.10\" --iteration=1")
