...
# From Unsupervised Learning for Intrinsic Image Decomposition from a Single Image
...
class AdaINGen(nn.Module):
    ...
    def __init__(self, input_dim, output_dim, params, use_dropout = False):
        ...
        self.dec = Decoder(n_downsample, n_res, self.enc_content.output_dim, output_dim, res_norm='in', activ=activ,
                           pad_type=pad_type)
