...
def main():
    os.system("python \"iid_train_v3.py\" --server_config=2 --cuda_device=\"cuda:2\" --img_to_load=-1 --train_mode=\"train_shadow_matte\" "
    ...
    os.system("python \"iid_train_v3.py\" --server_config=2 --cuda_device=\"cuda:2\" --img_to_load=-1 --train_mode=\"train_shadow\" "
