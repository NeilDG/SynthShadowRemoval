...
def main():
    ...
    #           "--mode=azimuth --input_light_angle=0 --desired_light_angle=144 --version_name=\"shadow2relight_v1.02\" --iteration=5")
    #
    # os.system("python \"shadow_remap_test.py\" --img_to_load=-1 --net_config=2 --num_blocks=0 "
    #           "--mode=azimuth --input_light_angle=36 --desired_light_angle=144 --version_name=\"shadow2relight_v1.02\" --iteration=5")
    #
    # os.system("python \"shadow_remap_test.py\" --img_to_load=-1 --net_config=2 --num_blocks=0 "
    #           "--mode=azimuth --input_light_angle=72 --desired_light_angle=144 --version_name=\"shadow2relight_v1.02\" --iteration=5")
    #
    # os.system("python \"shadow_remap_test.py\" --img_to_load=-1 --net_config=2 --num_blocks=0 "
    #           "--mode=azimuth --input_light_angle=108 --desired_light_angle=144 --version_name=\"shadow2relight_v1.02\" --iteration=5")
    #
    # os.system("python \"shadow_remap_test.py\" --img_to_load=-1 --net_config=2 --num_blocks=0 "
    #           "--mode=azimuth --input_light_angle=144 --desired_light_angle=144 --version_name=\"shadow2relight_v1.02\" --iteration=5")
