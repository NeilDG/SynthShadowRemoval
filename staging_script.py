...
def main():
    ...
    os.system("python \"iid_render_main_2.py\" --num_workers=12 --img_to_load=-1 --patch_size=32 "
              "--net_config_a=5 --num_blocks_a=0 --net_config_s1=1 --num_blocks_s1=6 --net_config_s2=1 --num_blocks_s2=6 --net_config_s3=2 --num_blocks_s3=0 "
              "--version_albedo=\"rgb2albedo_v7.22\" --iteration_a=8 "
              "--version_shading=\"rgb2shading_v8.05\" --iteration_s1=5 "
    ...
    os.system("python \"iid_render_main_2.py\" --num_workers=12 --img_to_load=-1 --patch_size=32 "
              ...
              "--version_shading=\"rgb2shading_v8.05\" --iteration_s1=5 "
              "--version_shadow=\"rgb2shadow_v8.05\" --iteration_s2=5 "
              "--version_shadow_remap=\"shadow2relight_v1.04\" --iteration_s3=6 "
              "--mode=azimuth --light_color=\"255,255,255\" --test_code=001")
    ...
    os.system("python \"iid_render_main_2.py\" --num_workers=12 --img_to_load=-1 --patch_size=32 "
              ...
              "--version_shading=\"rgb2shading_v8.05\" --iteration_s1=5 "
              "--version_shadow=\"rgb2shadow_v8.05\" --iteration_s2=5 "
              "--version_shadow_remap=\"shadow2relight_v1.04\" --iteration_s3=7 "
              "--mode=azimuth --light_color=\"255,255,255\" --test_code=001")
    ...
    os.system("python \"iid_render_main_2.py\" --num_workers=12 --img_to_load=-1 --patch_size=32 "
              ...
              "--version_shading=\"rgb2shading_v8.05\" --iteration_s1=5 "
              "--version_shadow=\"rgb2shadow_v8.05\" --iteration_s2=5 "
              "--version_shadow_remap=\"shadow2relight_v1.04\" --iteration_s3=8 "
              "--mode=azimuth --light_color=\"255,255,255\" --test_code=001")
