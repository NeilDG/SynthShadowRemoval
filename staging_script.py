...
def main():
    ...
    #           "--version_albedo=\"rgb2albedo_v6.01\" --iteration_a=1 "
    #           "--version_shading=\"rgb2shading_v7.01\" --iteration_s1=1 "
    #           "--version_shadow=\"rgb2shadowmap_v7.09\" --iteration_s2=1 "
    #           "--mode=elevation --light_angle=144 --light_color=\"225,247,250\"")
    ...
    # os.system("python \"defer_render_test.py\"")
