...
def test_shadow():
    ...
    #           "--shadow_matte_version=\"rgb2sm_v61.28_places\" --shadow_removal_version=\"rgb2ns_v61.26_places\" "
    ...
    os.system("python \"shadow_test_main.py\" --server_config=5 --img_to_load=-1 "
              ...
              "--shadow_matte_version=\"rgb2sm_v61.25_places\" --shadow_removal_version=\"rgb2ns_v61.26_places\" "
              "--shadow_matte_iteration=1 --shadow_removal_iteration=1 --load_best=0")
    ...
    #           "--shadow_matte_version=\"rgb2sm_v58.28_istd\" --shadow_removal_version=\"rgb2ns_v61.23_places\" "
    #           "--shadow_matte_iteration=1 --shadow_removal_iteration=1")
    #
    # os.system("python \"shadow_test_main-3.py\" --server_config=5 --img_to_load=200000 "
