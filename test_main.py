...
def test_shadow():
    ...
    os.system("python \"shadow_test_main.py\" --server_config=5 --img_to_load=-1 "
              ...
              "--shadow_matte_version=\"rgb2sm_v61.35_places\" --shadow_removal_version=\"rgb2ns_v61.26_places\" "
    ...
    #           "--shadow_matte_version=\"rgb2sm_v61.28_places\" --shadow_removal_version=\"rgb2ns_v61.39_places\" "
    #           "--shadow_matte_iteration=1 --shadow_removal_iteration=1 --load_best=1")
