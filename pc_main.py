...
def main():
    ...
    # #
    os.system("python \"render_segment_main.py\" --num_workers=12 --img_to_load=-1 --load_previous=0 --test_mode=0 --batch_size=256 "
    ...
    #           "--net_config=2 --l1_weight=1.0 --lpip_weight=10.0 --ssim_weight=0.0 --use_0bce=1 "
