...
def train_shadow_matte():
    ...
    #           "--plot_enabled=0 --save_per_iter=1000 --network_version=\"rgb2sm_v61.84_istd\" --iteration=1")
    #
    # os.system("python3 \"shadow_train_main.py\" --server_config=3 --img_to_load=-1 --train_mode=\"train_shadow_matte\" "
    #           "--plot_enabled=0 --save_per_iter=1000 --network_version=\"rgb2sm_v61.84_srd\" --iteration=1")

    os.system("python3 \"shadow_train_main.py\" --server_config=3 --img_to_load=-1 --train_mode=\"train_shadow_matte\" "
              "--plot_enabled=0 --save_per_iter=1000 --network_version=\"rgb2sm_v61.85_istd\" --iteration=1")

    os.system("python3 \"shadow_train_main.py\" --server_config=3 --img_to_load=-1 --train_mode=\"train_shadow_matte\" "
              "--plot_enabled=0 --save_per_iter=1000 --network_version=\"rgb2sm_v61.85_srd\" --iteration=1")
