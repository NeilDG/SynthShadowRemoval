...
def main():
    os.system("python \"iid_train.py\" --server_config=2 --cuda_device=\"cuda:0\" --img_to_load=-1 --load_previous=0 --test_mode=0 --patch_size=64 --batch_size=1024 "
    ...
    os.system("python \"iid_train.py\" --server_config=2 --cuda_device=\"cuda:0\" --img_to_load=-1 --load_previous=0 --test_mode=0 --patch_size=64 --batch_size=1024 "
              "--net_config=2 --num_blocks=0 "
              "--plot_enabled=0 --debug_mode=0 --version_name=\"iid_networkv5.01\" --iteration=5")

    os.system("python \"iid_train.py\" --server_config=2 --cuda_device=\"cuda:0\" --img_to_load=-1 --load_previous=0 --test_mode=0 --patch_size=64 --batch_size=1024 "
              "--net_config=2 --num_blocks=0 "
              "--plot_enabled=0 --debug_mode=0 --version_name=\"iid_networkv5.01\" --iteration=6")

    os.system("python \"iid_train.py\" --server_config=2 --cuda_device=\"cuda:0\" --img_to_load=-1 --load_previous=0 --test_mode=0 --patch_size=64 --batch_size=1024 "
              "--net_config=2 --num_blocks=0 "
              "--plot_enabled=0 --debug_mode=0 --version_name=\"iid_networkv5.01\" --iteration=7")

    os.system("python \"iid_train.py\" --server_config=2 --cuda_device=\"cuda:0\" --img_to_load=-1 --load_previous=0 --test_mode=0 --patch_size=64 --batch_size=1024 "
              "--net_config=2 --num_blocks=0 "
              "--plot_enabled=0 --debug_mode=0 --version_name=\"iid_networkv5.01\" --iteration=8")
