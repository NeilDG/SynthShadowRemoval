...
def train_proper(gpu_device):
    ...
    os.system("python \"shadow_train_main-3.py\" --server_config=5 --img_to_load=100000 --train_mode=\"train_shadow\" "
              "--plot_enabled=0 --save_per_iter=500 --network_version=\"rgb2ns_v61.26_places\" --iteration=1")

    os.system("python \"shadow_train_main-3.py\" --server_config=5 --img_to_load=50000 --train_mode=\"train_shadow\" "
              "--plot_enabled=0 --save_per_iter=500 --network_version=\"rgb2ns_v61.26_places\" --iteration=1")
