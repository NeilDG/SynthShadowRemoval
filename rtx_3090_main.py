...
def train_shadow_matte():
    ...
    #
    # os.system("python \"shadow_train_main-2.py\" --server_config=5 --img_to_load=-1 --train_mode=\"train_shadow_matte\" "
    #           "--plot_enabled=0 --save_every_epoch=5 --epoch_to_load=35 --network_version=\"rgb2sm_v61.31_istd\" --iteration=1")
    #
