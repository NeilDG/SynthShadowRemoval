...
def train_shadow_matte():
    ...
    # FOR TESTING
    os.system("python \"shadow_train_main-2.py\" --server_config=5 --img_to_load=1000 --train_mode=\"train_shadow_matte\" "
              "--plot_enabled=1 --save_every_epoch=10 --epoch_to_load=0 --network_version=\"rgb2sm_v61.28_places\" --iteration=1")
