...
def train_shadow_removal():
    os.system("python \"shadow_train_main.py\" --server_config=5 --img_to_load=100000 --train_mode=\"train_shadow\" "
              "--plot_enabled=0 --network_version=\"rgb2ns_v61.26_places\" --iteration=1")
