...
def train_shadow_matte():
    ...
    #           "--plot_enabled=0 --save_per_iter=1000 --network_version=\"rgb2sm_v61.83_istd\" --iteration=1")

    # os.system("python \"shadow_train_main.py\" --server_config=5 --img_to_load=-1 --train_mode=\"train_shadow_matte\" "
    #           "--plot_enabled=0 --save_per_iter=1000 --network_version=\"rgb2sm_v61.83_srd\" --iteration=1")
    ...
    #
    # os.system("python \"shadow_train_main.py\" --server_config=5 --img_to_load=-1 --train_mode=\"train_shadow_matte\" "
    #           "--plot_enabled=0 --save_per_iter=1000 --network_version=\"rgb2sm_v61.78_places\" --iteration=1")
    #
    # os.system("python \"shadow_train_main.py\" --server_config=5 --img_to_load=-1 --train_mode=\"train_shadow_matte\" "
...
def train_shadow_removal():
    ...
    #           "--plot_enabled=0 --save_per_iter=1000 --network_version=\"rgb2ns_v61.40_synshadow\" --iteration=1")
