...
def train_shadow_matte():
    ...
    os.system("python \"shadow_train_main.py\" --server_config=5 --img_to_load=10000 --train_mode=\"train_shadow_matte\" "
              "--plot_enabled=0 --save_per_iter=500 --network_version=\"rgb2sm_v61.02\" --iteration=1")
...
def train_shadow_removal():
    os.system("python \"shadow_train_main-2.py\" --server_config=5 --img_to_load=100 --train_mode=\"train_shadow\" "
              "--plot_enabled=0 --save_per_iter=500 --network_version=\"rgb2ns_v61.14_places\" --iteration=1")
