...
def train_relighting():
    ...
    #           "--plot_enabled=0  --shadow_matte_network_version=\"v60.01\" --shadow_removal_version=\"v60.02_places\" "
    #           "--shadow_matte_iteration=4 --shadow_removal_iteration=1")

    os.system("python \"iid_train_v3.py\" --server_config=5 --img_to_load=250 --train_mode=\"train_shadow_matte\" "
             "--plot_enabled=1  --shadow_matte_network_version=\"v60.05\" --shadow_removal_version=\"v60.02_places\" "
             "--shadow_matte_iteration=4 --shadow_removal_iteration=1")
