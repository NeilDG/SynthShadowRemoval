...
def train_relighting():
    os.system("python \"iid_train.py\" --server_config=5 --img_to_load=1000 --load_previous=0 --test_mode=0 --patch_size=64 --batch_size=72 --min_epochs=20 "
              "--net_config=4 --num_blocks=6 "
              "--plot_enabled=1 --debug_mode=0 --version_name=\"iid_networkv9.04\" --iteration=13 "
