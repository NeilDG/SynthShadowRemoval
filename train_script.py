...
def train_relighting():
    os.system("python \"iid_train_v3.py\" --server_config=5 --img_to_load=-1 --debug_run=0 "
              "--plot_enabled=0 --version=\"v37.01\" --iteration=6")

    os.system("python \"iid_train_v3.py\" --server_config=5 --img_to_load=-1 --debug_run=0 "
              "--plot_enabled=0 --version=\"v37.01\" --iteration=1")

    os.system("python \"iid_train_v3.py\" --server_config=5 --img_to_load=-1 --debug_run=0 "
              "--plot_enabled=0 --version=\"v37.01\" --iteration=2")

    os.system("python \"iid_train_v3.py\" --server_config=5 --img_to_load=-1 --debug_run=0 "
              "--plot_enabled=0 --version=\"v37.01\" --iteration=9")
