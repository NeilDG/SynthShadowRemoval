...
def train_relighting():
    os.system("python \"iid_train_v3.py\" --server_config=5 --img_to_load=-1 --debug_run=0 "
              "--plot_enabled=0 --version=\"v27.04\" --iteration=5")

    os.system("python \"iid_train_v3.py\" --server_config=5 --img_to_load=-1 --debug_run=0 "
              "--plot_enabled=0 --version=\"v27.04\" --iteration=6")

    os.system("python \"iid_train_v3.py\" --server_config=5 --img_to_load=-1 --debug_run=0 "
              "--plot_enabled=0 --version=\"v27.04\" --iteration=1")

    os.system("python \"iid_train_v3.py\" --server_config=5 --img_to_load=-1 --debug_run=0 "
              "--plot_enabled=0 --version=\"v27.04\" --iteration=2")

    os.system("python \"iid_train_v3.py\" --server_config=5 --img_to_load=-1 --debug_run=0 "
              "--plot_enabled=0 --version=\"v27.04\" --iteration=3")

    os.system("python \"iid_train_v3.py\" --server_config=5 --img_to_load=-1 --debug_run=0 "
              "--plot_enabled=0 --version=\"v27.04\" --iteration=4")
