...
def train_relighting():
    os.system("python \"iid_train_v3.py\" --server_config=5 --img_to_load=-1 --debug_run=0 "
              "--plot_enabled=1 --version=\"v18.11\" --iteration=3")

    os.system("python \"iid_train_v3.py\" --server_config=5 --img_to_load=-1 --debug_run=0 "
              "--plot_enabled=0 --version=\"v18.11\" --iteration=4")

    os.system("python \"iid_train_v3.py\" --server_config=5 --img_to_load=-1 --debug_run=0 "
              "--plot_enabled=0 --version=\"v18.11\" --iteration=5")

    os.system("python \"iid_train_v3.py\" --server_config=5 --img_to_load=-1 --debug_run=0 "
              "--plot_enabled=0 --version=\"v18.11\" --iteration=6")
