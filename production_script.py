...
def train_domain_adaptation():
    os.system("python \"cyclegan_main.py\" --server_config=5 --img_to_load=5000 --load_previous=0 --test_mode=0 --net_config=1 --num_blocks=9 "
              "--patch_size=32 --img_per_iter=8 --batch_size=4096 "
