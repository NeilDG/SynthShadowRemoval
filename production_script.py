...
def main():
    ...
    #           "--l1_weight=10.0 --lpip_weight=0.0 --ssim_weight=1.0 --adv_weight=1.0 --use_bce=0 --mode=azimuth --min_epochs=100 --light_angle=0 "
    #           "--version_name=\"rgb2shadow_v8.01\" --iteration=1")
    ...
    os.system("python \"shading_main.py\" --num_workers=12 --img_to_load=-1 --load_previous=0 --test_mode=0 --patch_size=64 --batch_size=512 --net_config=2 --num_blocks=0 "
