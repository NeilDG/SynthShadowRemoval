...
def train_domain_adaptation():
    os.system("python \"cyclegan_main.py\" --server_config=5 --img_to_load=-1 --load_previous=1 --test_mode=0 --net_config=1 --num_blocks=9 "
              "--patch_size=32 --img_per_iter=8 --batch_size=32 " 
              "--min_epochs=40 --g_lr=0.0002 --d_lr=0.0002 --version_name=\"synth2rgb_v4.01\" --iteration=3")
def main():
    # train_albedo()
    # train_shading()
    # train_shadow()
