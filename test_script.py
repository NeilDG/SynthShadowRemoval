...
def test_relighting():
    os.system("python \"iid_test_v3.py\" --server_config=5 --img_to_load=-1 "
              "--plot_enabled=1 --img_vis_enabled=1 --version=\"v50.07\" --iteration=1")

    os.system("python \"iid_test_v3.py\" --server_config=5 --img_to_load=-1 "
              "--plot_enabled=1 --img_vis_enabled=1 --version=\"v50.07\" --iteration=2")

    os.system("python \"iid_test_v3.py\" --server_config=5 --img_to_load=-1 "
              "--plot_enabled=1 --img_vis_enabled=1 --version=\"v50.07\" --iteration=3")

    os.system("python \"iid_test_v3.py\" --server_config=5 --img_to_load=-1 "
              "--plot_enabled=1 --img_vis_enabled=1 --version=\"v50.07\" --iteration=4")
