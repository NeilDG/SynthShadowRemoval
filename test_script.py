...
def test_relighting():
    ...
    os.system("python \"iid_test.py\"  --net_config=2 --num_blocks=0 --version_name=\"maps2rgb_rgb2maps_v4.13\" --iteration=9 "
              "--input_path=\"E:/IID-TestDataset/GTA/input/\" --output_path=\"E:/IID-TestDataset/GTA/ours/\"")

    os.system("python \"iid_test.py\"  --net_config=2 --num_blocks=0 --version_name=\"maps2rgb_rgb2maps_v4.13\" --iteration=10 "
              "--input_path=\"E:/IID-TestDataset/GTA/input/\" --output_path=\"E:/IID-TestDataset/GTA/ours/\"")

    os.system("python \"iid_test.py\"  --net_config=2 --num_blocks=0 --version_name=\"maps2rgb_rgb2maps_v4.13\" --iteration=11 "
              "--input_path=\"E:/IID-TestDataset/GTA/input/\" --output_path=\"E:/IID-TestDataset/GTA/ours/\"")

    os.system("python \"iid_test.py\"  --net_config=2 --num_blocks=0 --version_name=\"maps2rgb_rgb2maps_v4.13\" --iteration=12 "
              "--input_path=\"E:/IID-TestDataset/GTA/input/\" --output_path=\"E:/IID-TestDataset/GTA/ours/\"")
